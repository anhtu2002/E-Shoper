<x-layout_admin :title="'Danh sách thương hiệu sản phẩm'">
                    ...
                    @if(count($all_brand) != 0)
                        @foreach ($all_brand as $brand)
                            ...
                            @if ($brand->brand_status == 0)
                                <td>
                                    <a href="{{ route('admin.change_status_brand', ['brand_id'=> $brand->id]) }}">
                            ...
                            @endif
                                <td><span class="text-ellipsis">{{$brand->updated_at}}  </span></td>
                                    <td>
                                        <a href="{{ route('admin.edit_brand', ['brand_id'=> $brand->id]) }}" class="active" ui-toggle-class="">
                                            <i class="fa-solid fa-pen"></i>
                                        </a>
                                        <a href="{{ route('admin.delete_brand', ['brand_id'=> $brand->id]) }}" onclick="confirm_delete()" class="active" ui-toggle-class="">
